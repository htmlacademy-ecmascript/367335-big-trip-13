...
/* harmony import */ var _view_no_events__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/no-events */ "./src/view/no-events.js");
...
/* harmony import */ var _const__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./const */ "./src/const.js");
...
const eventsCount = Object(_utils__WEBPACK_IMPORTED_MODULE_15__["getRandomInt"])(...EVENTS_RANGE);
...
Object(_utils__WEBPACK_IMPORTED_MODULE_15__["renderElement"])(infoElement, new _view_cost__WEBPACK_IMPORTED_MODULE_1__["default"](events).getElement());
Object(_utils__WEBPACK_IMPORTED_MODULE_15__["renderElement"])(headerMainElement, new _view_new_button__WEBPACK_IMPORTED_MODULE_4__["default"]().getElement());
Object(_utils__WEBPACK_IMPORTED_MODULE_15__["renderElement"])(headerMainElement, infoElement, _const__WEBPACK_IMPORTED_MODULE_14__["RenderPosition"].AFTERBEGIN);

const controlsElement = headerMainElement.querySelector(`.trip-controls`);
Object(_utils__WEBPACK_IMPORTED_MODULE_15__["renderElement"])(controlsElement.querySelector(`h2`), new _view_tabs__WEBPACK_IMPORTED_MODULE_2__["default"]().getElement(), _const__WEBPACK_IMPORTED_MODULE_14__["RenderPosition"].AFTEREND);
Object(_utils__WEBPACK_IMPORTED_MODULE_15__["renderElement"])(controlsElement, new _view_filters__WEBPACK_IMPORTED_MODULE_3__["default"]().getElement());

const eventsElement = document.querySelector(`.trip-events`);
if (eventsCount) {
  Object(_utils__WEBPACK_IMPORTED_MODULE_15__["renderElement"])(eventsElement, new _view_sort__WEBPACK_IMPORTED_MODULE_5__["default"]().getElement());

  const listElement = new _view_events_list__WEBPACK_IMPORTED_MODULE_6__["default"]().getElement();
  Object(_utils__WEBPACK_IMPORTED_MODULE_15__["renderElement"])(eventsElement, listElement);

  events.forEach((eventData) => {
    const eventComponent = new _view_event__WEBPACK_IMPORTED_MODULE_8__["default"](eventData);
    const eventEditComponent = new _view_event_edit__WEBPACK_IMPORTED_MODULE_9__["default"]({
      eventData,
    ...
    Object(_utils__WEBPACK_IMPORTED_MODULE_15__["renderElement"])(listElement, eventComponent.getElement());
  });
} else {
  Object(_utils__WEBPACK_IMPORTED_MODULE_15__["renderElement"])(eventsElement, new _view_no_events__WEBPACK_IMPORTED_MODULE_7__["default"]().getElement());
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return NoEventsView; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/utils.js");
